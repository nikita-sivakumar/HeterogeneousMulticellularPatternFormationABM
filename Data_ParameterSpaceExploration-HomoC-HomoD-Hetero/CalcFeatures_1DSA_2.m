...
for k = 1:length(folders)
    ...
    features = [];
    filenames = [];
    feature_names = ["file-path" "homo_c" "homo_d" "hetero" "a-count" "b-count" "c-color-count" "c-express-count" "d-color-count" "d-express-count" "cell-count" "num_green_regions" "num_lone_green_regions" "green_avg_regionArea_fract" "green_area_fract" "green_avg_cent_dist" "green_region_width" "green_region_height" "green_region_aspect_ratio" "num_red_regions" "num_red_lone" "red_avg_regionArea_fract" "red_area_fract" "red_avg_cent_dist" "red_region_width" "red_region_height"  "red_region_aspect_ratio" "num_blue_regions" "num_blue_lone" "blue_avg_regionArea_fract" "blue_area_fract" "blue_avg_cent_dist" "contiguous_area"];
    files = dir('*.txt');
    filecount = 1;
